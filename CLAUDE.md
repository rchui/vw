...
- UNION operator (|) → `docs/quickstart.md` (Set Operations > UNION), `docs/api/postgres.md` (Set Operations > Operators > |)
- UNION ALL operator (+) → `docs/quickstart.md` (Set Operations > UNION ALL), `docs/api/postgres.md` (Set Operations > Operators > +)
- INTERSECT operator (&) → `docs/quickstart.md` (Set Operations > INTERSECT), `docs/api/postgres.md` (Set Operations > Operators > &)
- EXCEPT operator (-) → `docs/quickstart.md` (Set Operations > EXCEPT), `docs/api/postgres.md` (Set Operations > Operators > -)
- Set operations chaining → `docs/quickstart.md` (Set Operations > Chaining), `docs/api/postgres.md` (Set Operations > Chaining)
